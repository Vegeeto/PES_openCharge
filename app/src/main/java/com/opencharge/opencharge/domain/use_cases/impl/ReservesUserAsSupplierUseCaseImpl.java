...
public class ReservesUserAsSupplierUseCaseImpl extends AbstractUseCase implements ReservesUserAsSupplierUseCase {
    private ReservesUserAsSupplierUseCase.Callback callback;
    private ReserveRepository reserveRepository;
    private String userID;

    public ReservesUserAsSupplierUseCaseImpl(Executor threadExecutor,
                                          MainThread mainThread,
                                          ReserveRepository reserveRepository,
                                             ReservesUserAsSupplierUseCase.Callback callback) {
